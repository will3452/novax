  ...
  return _c(
    ...
    [
      _c(
        "vue-final-modal",
        {
          attrs: { "esc-to-close": true, "hide-overlay": false },
          model: {
            value: _vm.modalShow,
            callback: function ($$v) {
              _vm.modalShow = $$v
        ...
        [
          _c(
            ...
            {
              staticClass:
                "h-screen w-screen flex justify-center p-4 items-center",
            },
            [
              _c("div", { staticClass: "bg-white p-4 px-8" }, [
                ...
                _c("input", {
                  ...
                  staticClass: "block border-2 form-control",
                  attrs: { type: "number", min: "1", placeholder: "₱ 100.00" },
      ...
      _c("div", { staticClass: "px-3 py-3" }, [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "text-center text-4xl mt-2" }, [
          _vm._v(
            "\n            " +
              _vm._s(_vm._f("formatCurrency")(_vm.card.balance)) +
              "\n        "
          ),
        ]),
        _vm._v(" "),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _this.axios.post(_this.card.postUrl, {
                  amount: _this.amount,
                  user_id: _this.card.userId
                });
              case 3:
                data = _context.sent;
                console.log(data);
                _this.$toasted.success('Success');
                _context.next = 11;
                break;
              case 8:
                _context.prev = 8;
                _context.t0 = _context["catch"](0);
                _this.$toasted.error('Error >> ' + _context.t0);
              case 11:
              case "end":
  ...
  filters: {
    formatCurrency: function formatCurrency(data) {
      var formatting_options = {
        style: 'currency',
        currency: 'PHP',
        minimumFractionDigits: 2
      };
      var formatter = new Intl.NumberFormat('en-US', formatting_options);
...
Nova.booting(function (Vue, router, store) {
  Vue.use(vue_final_modal__WEBPACK_IMPORTED_MODULE_1__.vfmPlugin);
  Vue.use((vue_toasted__WEBPACK_IMPORTED_MODULE_2___default()), {
    duration: 2000
  });
  Vue.component('current-balance', _components_Card_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
