...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('/nova-vendor/user-time-record/get-records').then(function (res) {
  ...
  methods: {
    recordSelected: function recordSelected() {
      ...
      this.records.forEach(function (data) {
        if (data.id === _this2.selectedRecordId) {
          _this2.position = data.position;
          _this2.main = data.is_main;
          _this2.customer = data.record.company_control_number;
          _this2.customerDueDate = data.customer_due_date;
          _this2.companyDueDate = data.company_due_date;
        }
      });
    },
...
Nova.booting(function (Vue, router, store) {
  Vue.component('user-time-record', _components_Card_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
