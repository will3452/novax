<x-layout>
  ...
  <div class="p-2 mt-2 mx-auto md:w-11/12">
    <h1 class=" z-2 text-4xl font-custom hover:underline text-center bg-white p-4"> Feature Attraction</h1>
    <x-place-details :attraction="\App\Models\Destination::with(['category', 'photographs'])->inRandomOrder()->first()"></x-place-details>
    <h1 class=" z-2 text-4xl font-custom hover:underline text-center bg-white p-4"> Attractions</h1>
    ...
    <h1 class=" z-1 text-4xl font-custom hover:underline text-center bg-white p-4 mt-4"> Blogs</h1>
    ...
    <h1 class=" z-1 text-4xl font-custom hover:underline text-center bg-white p-4 mt-4"> Feedback / Testimonials</h1>
    ...
    <h1 class=" z-1 text-4xl font-custom hover:underline text-center bg-white p-4 mt-8"> Contact Us</h1>
    <div class="flex">
