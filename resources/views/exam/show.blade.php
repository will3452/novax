<x-new-layout>
    ...
    @teacher
    <div class="d-flex justify-between my-4 items-center justify-content-between">
        ...
        <div class="tabs">
            ...
            <a  href="{{route('exam.result', ['exam' => $exam->id])}}"  class="btn {{route('exam.result', ['exam' => $exam->id]) == url()->current() ? 'btn-dark':''}}">Submissions</a>
            <a  href="{{route('exam.report', ['exam' => $exam->id])}}" class="btn {{route('exam.report', ['exam' => $exam->id]) == url()->current() ? 'btn-dark':''}}">Reports</a>
        </div>
    </div>
    @endteacher
